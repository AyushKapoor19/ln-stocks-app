...
var StateMachine = class _StateMachine {
  ...
  _callEnter(state3, args = [], context) {
    ...
    if (state3.prototype.$enter) {
      if (!hasParent || state3.__parent.prototype.$enter !== state3.prototype.$enter) {
        state3.prototype.$enter.apply(this, [context, ...args]);
      }
    }
  }
  _callExit(state3, args = [], context) {
    const hasParent = !!state3.__parent;
    if (state3.prototype.$exit) {
      if (!hasParent || state3.__parent.prototype.$exit !== state3.prototype.$exit) {
        state3.prototype.$exit.apply(this, [context, ...args]);
      }
    }
  }
  __setState(state3) {
...
var Purchase_default = {
  setup(config) {
    if (config.cspUrl)
      cspUrl = config.cspUrl;
    if (config.endpoints)
      cspEndpoints = { cspEndpoints, ...config.endpoints };
  },
  assets() {
    return new Promise((resolve, reject) => {
